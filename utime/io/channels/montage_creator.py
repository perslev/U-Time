...
#     in_file = ['EOG', 'C3-M2', 'C2', 'M1', 'M2', "Cjeen-abc"]
#     required = ('C3-M2', "C2-A1", "O2-A1")
#     c = ChannelMontageCreator(in_file, required, allow_missing=True)
#
#     print(c.channels_required)
#     print(c.existing_channels)
#     print(c.channels_to_load)
#     print(c.channels_to_load.original_names)
#     print(c.output_channels)
#
#     loaded_data = np.arange(10 * 3).reshape(10, 3)
#     montage_data, channels = c.create_montages(loaded_data)
#
#     print(loaded_data.shape)
#     print(montage_data.shape, channels)
