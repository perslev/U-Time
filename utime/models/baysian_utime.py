...
class BaysianUTime(Model):
    ...
    def __init__(self,
        ...
        build (bool):
            TODO
        """
        super(BaysianUTime, self).__init__()
    ...
    def create_encoder(in_,
        ...
        for i in range(depth):
            l_name = name + "_L%i" % i
            conv = tfp.layers.Convolution2DFlipout(filters, (kernel_size, 1),
    ...
    def create_upsample(self,
        ...
        for i in range(depth):
            ...
            up = UpSampling2D(size=(fs, 1),
                              name=l_name + "_up")(in_)
            conv = tfp.layers.Convolution2DFlipout(filters, (fs, 1),
    ...
    def create_dense_modeling(self,
                              ...
                              name_prefix="",
                              **kwargs):
        cls = tfp.layers.Convolution2DFlipout(filters=filters,
                     kernel_size=(1, 1),
                     #kernel_regularizer=kernel_reg,
    ...
    def create_seq_modeling(in_,
        ...
        out = tfp.layers.Convolution2DFlipout(filters=n_classes,
